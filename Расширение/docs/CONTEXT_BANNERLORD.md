...
Ещё НЕ проверено: бой, осада, армия, плен. Известная дыра: экраны, требующие
решения игрока (госрешения королевства у правителя), держат время на паузе,
блокируют цикл и автопилотом не распознаются — он выглядит зависшим.
