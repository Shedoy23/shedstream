...
namespace TaleWorlds.CampaignSystem {
 ...
 public class PartyThinkParams {
  public List<(AIBehaviorData,float)> AIBehaviorScores {private get;set;} = new();
 ...
 public class CampaignEventDispatcher {
  ...
  public void AiHourlyTick(MobileParty p, PartyThinkParams t) { t.AIBehaviorScores = new(NextScores); }
 }
}
