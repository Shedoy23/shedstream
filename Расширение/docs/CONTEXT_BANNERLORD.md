...
денег и потолками трат (README мода, «Обслуживание партии в поселении»). Стенд
102/0, контракт 176/176. P1 итоговой проверки закрывается только прогоном в игре. Бой, плен, окна и решения королевства пока не сделаны; план с
поправками проверки — `BannerlordAutopilot/review/unattended-play-engine-notes.md`,
ответы — `BannerlordAutopilot/review/RESPONSE_2026-09-13.md`.
