...
namespace BannerlordAutopilot
{
    ...
    {
        /// <summary>Владелец 25.09 (стрим): «отступление только при 5х перевесе
        /// везде» — отходил от бандитов при 10–30 лишних врагах, а зрители
        /// призываются в бой и сами добирают силу. Было 2x (23.09).</summary>
        internal const float FleeRatio = 5f;
