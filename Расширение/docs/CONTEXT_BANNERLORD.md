...
героя, V на 30-м; покупка за Hero.Gold, затем отдельное надевание/снятие.
...
health и публичные хэши проверены. DLL установлена 17.09 01:38 +05 с копией
старой версии и сверкой хэша. ZIP/CDN не менялись; живой бой не проверен.
