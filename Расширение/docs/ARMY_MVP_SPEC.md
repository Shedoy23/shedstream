# ARMY MVP — спека (готова к сборке)

Статус: **дизайн зафиксирован + физибилити проверена 2026-06-14**, код НЕ написан (отложено
в отдельную сессию ради качества). Свежий чат: читай это + начинай с C#-слоя.
