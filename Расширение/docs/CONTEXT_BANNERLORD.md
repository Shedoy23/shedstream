...
остановка 161 с в деревне — время заперто, по признакам окно случайного события
карты, которое автопилот не видит. Еда, пленные и пределы трат прогоном не проверены. Бой, плен, окна и решения королевства пока не сделаны; план с
