...
1. Загружен АКТУАЛЬНЫЙ архив `0.0.5` от 10.09: MD5 `059806841c3b84790af97c1056c4c3f5`,
   SHA-256 `6f7e115bfd8bdabbd254a4c1f42cf730961d56f06da0523161d3a54ab43da253`, 249 294 байта. Лежит в
   `.claude/worktrees/codex-public-release/dist/shedlink-0.0.5.zip`.
   Все прежние архивы `0.0.5` отменены. Перед Submit значение MD5 в Dev Console
   должно быть записано и совпадать с `059806841c3b84790af97c1056c4c3f5`.
...
## Что владелец дописывает перед Submit for Review

Реальное окно доступности канала и игры в UTC. Если постоянный эфир невозможен,
указать ближайшее выдерживаемое окно и контакт для переноса; время не выдумывать.
