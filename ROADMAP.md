...
### Совместимость Bannerlord и ShedColony со сборками модов
...
переписанной механики. RimLink служит ориентиром, но тоже не гарантирует
совместимость с любым сторонним модом.

- [ ] Проверить Bannerlord и ShedColony от каталога и кнопки до игрового
      обработчика: где читаются реальные данные игры, а где предполагаются
      фиксированные фракции, войска, предметы, профессии и исследования.
