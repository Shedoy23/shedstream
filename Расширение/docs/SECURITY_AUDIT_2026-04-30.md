...
2. **Слабые секреты в `.env`** — ADMIN_PASSWORD = 8 цифр (`33133313`), EVENTSUB_SECRET = 12 цифр (`331333133313`). Оба брутфорсятся за минуты. Failed-login-counter существует, но **не блокирует** попытки.
...
**Файл:** `.env` строка 9 (`ADMIN_PASSWORD=33133313`)
...
**Файл:** `.env` строка 13 (`EVENTSUB_SECRET=331333133313`)
