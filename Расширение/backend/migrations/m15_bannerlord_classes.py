...
BANNERLORD_CLASSES_SEED = [
    ...
    ("archer",       "Лучник",          "Ranged",         "Bow",             "Arrows",          "",                "",          0, 0, "Стреляет издалека, лёгкая броня."),
    ("heavy_archer", "Тяжёлый Лучник",  "Ranged",         "Bow",             "Arrows",          "Shield",          "OneHandedWeapon", 0, 0, "Лучник с щитом и одноручкой для ближнего боя."),
    ("crossbow",     "Арбалетчик",      "Ranged",         "Crossbow",        "Bolts",           "",                "",          0, 0, "Медленнее лучника, но пробивает броню."),
    ("heavy_crossbow","Тяжёлый Арбалетчик","Ranged",      "Crossbow",        "Bolts",           "Shield",          "OneHandedWeapon", 0, 0, "Арбалетчик в тяжёлой броне с щитом."),
    ...
    ("horse_archer", "Конный Лучник",   "HorseArcher",    "Bow",             "Arrows",          "OneHandedWeapon", "",          1, 0, "Степной лучник верхом."),
    ("camel_archer", "Верблюжий Лучник","HorseArcher",    "Bow",             "Arrows",          "OneHandedWeapon", "",          0, 1, "Конный лучник на верблюде."),
    ("psycho",       "Психопат",        "Infantry",       "TwoHandedWeapon", "",                "",                "",          0, 0, "Двуручник без брони — глубокая ярость."),
