...
namespace BannerlordAutopilot
{
    public partial class AutopilotBehavior
    {
        ...
        private bool TryRetreatWhenWounded()
        {
            ...
            // Раненого героя (здоровье < 20%) игра в сцену боя не пускает: бой идёт
            // только авторасчётом, зрителям некуда призываться. Поэтому здесь не 5x,
            // а прежние 0,8x (владелец 25.09 после потери 24 → 1 в авторасчёте).
