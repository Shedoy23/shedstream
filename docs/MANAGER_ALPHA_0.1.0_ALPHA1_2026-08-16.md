...
> Заменён `0.1.0-alpha.2`, см. `MANAGER_ALPHA_0.1.0_ALPHA2_2026-08-16.md`.
> Тестировщику не передавался; артефакты удалены, чтобы его нельзя было
> отправить по ошибке. Причина замены — инструкция для тестировщика и метка
> происхождения, а не дефект самой сборки.
