...
только тем, кто поднял ELO до 1100 — а на проде за два месяца **никто не
перешагнул стартовые 1000**. То есть зритель играл, не зная ни награды, ни
условия, а награда при этом не выплачивалась ни разу.
...
*Сделано 2026-07-29.* Отдельно записано владельцу: **сам порог, похоже,
недостижим при нынешней активности** — это вопрос к балансу, а не к панели.
