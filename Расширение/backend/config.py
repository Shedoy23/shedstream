...
CHAT_BONUS_MAX          = 60
# Дневной потолок бонуса на (канал, зритель). Нужен ровно из-за щедрости выше:
# кулдаун 10с допускает 360 бонусов в час, и без потолка сообщения стали бы
# выгоднее просмотра, а это стимул флудить, а не разговаривать. Живой рекорд —
# ~900💎 за день, так что честному собеседнику потолок не мешает: он рассчитан
# втрое выше самого разговорчивого дня, который у нас был.
CHAT_BONUS_DAILY_CAP    = 3000
