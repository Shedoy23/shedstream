...
CATALOG_SEED = [
    ...
    ('foundation_renown',  'Знамя клана',
     'Гордое знамя над станом — растит репутацию клана.', 1, None, 100_000,
     {'renown_daily': 1.0}),
    ('foundation_influence', 'Дипломатический корпус',
     'Послы клана наводят связи при дворе.', 1, None, 100_000,
     {'influence_daily': 0.5}),
    ('foundation_party', 'Усиленная свита',
     'Больше места в отряде и личной охране.', 1, None, 150_000,
     {'party_size_bonus': 10, 'retinue_size_bonus': 1}),
    # ── Tier 2 (требует T1) ──
    ('military_might', 'Военная мощь',
     'Войско клана становится сильнее и больше.', 2, 'foundation_party', 400_000,
     {'renown_daily': 2.0, 'party_size_bonus': 15, 'retinue_size_bonus': 1}),
    ('leadership_circle', 'Совет лидеров',
     'Внутренний круг советников увеличивает влияние.', 2,
     'foundation_influence', 400_000,
     {'influence_daily': 1.0, 'party_amount_bonus': 1}),
    # ── Tier 3 (требует T2) ──
    ('warlord_renown', 'Слава полководца',
     'Хроники о победах разлетаются по миру.', 3,
    ...
    ('master_general', 'Главнокомандующий',
     'Главнокомандующий собирает огромные армии вассалов.', 4,
    ...
    ('legendary_status', 'Легендарный статус',
     'Клан вписан в историю — это вершина всего.',
