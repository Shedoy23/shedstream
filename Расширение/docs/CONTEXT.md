...
**Last updated:** 2026-07-31 (аудит по спеке: закрыты §6, §9, §11 — умирающий
цикл начисления, бесплатная экипировка, призы без следа; полный прогон тестов
28/28. Аудит РАБОТЫ: треки A и D закрыты,
