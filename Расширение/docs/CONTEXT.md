...
**Last updated:** 2026-07-30 (аудит по спеке: закрыты §9 и §11 — бесплатная
экипировка и призы без следа; полный прогон тестов 27/27. Аудит РАБОТЫ: треки A и D закрыты,
...
кодировку, считает таймаут провалом и судит по коду возврата. Сейчас 27/27.
