...
- План перевода Manager на остальные игры записан:
  `docs/MANAGER_MULTI_GAME_PLAN.md`. Шесть мест кода знают про RimWorld
  напрямую, хотя манифест уже описывает поиск игры и версии. Ждёт решения
  владельца, какая игра вторая.
